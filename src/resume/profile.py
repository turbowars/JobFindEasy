...
# but never invented.
SKILLS_MASTER = [
    {"label": "Engineering Leadership", "items": [
        "People management", "Team leadership", "Hiring", "Mentorship",
        "Technical strategy", "Cross-functional alignment", "Roadmap ownership",
        "Stakeholder communication", "Communication skills",
        "Architecture reviews", "Hiring loops", "Onboarding playbooks",
        "Performance reviews", "Career laddering",
    ]},
    {"label": "Languages", "items": [
        "TypeScript", "JavaScript (ES2023)", "Go", "Python", "HTML5", "CSS3",
        "SQL", "GraphQL", "Bash", "C#", "Java",
    ]},
    {"label": "Frontend Frameworks and Libraries", "items": [
        "Frontend development", "React 18", "Next.js 14 (App Router, Server Actions, RSC, ISR, SSR, SSG)",
        "React Server Components", "Angular (2-17)", "AngularJS", "Redux",
        "Redux Toolkit", "TanStack Query", "Zustand", "RxJS", "NgRx", "Vue.js",
        "Svelte", "Web Components", "Lit", "Stencil",
    ]},
    {"label": "Build Tools, Bundlers, and Monorepos", "items": [
        "Vite", "Webpack 5", "Turbopack", "Rollup", "esbuild", "Module Federation",
        "Nx", "Turborepo", "Lerna", "pnpm workspaces", "Yarn workspaces",
        "Babel", "SWC", "TypeScript Project References",
    ]},
    {"label": "UI, Styling, and Design Systems", "items": [
        "Tailwind CSS", "CSS-in-JS (styled-components, Emotion, vanilla-extract)",
        "CSS Modules", "SASS/SCSS", "OOCSS", "PostCSS", "Material UI", "shadcn/ui",
        "Radix UI", "Headless UI", "Storybook", "Chromatic", "Figma tokens",
        "Style Dictionary", "Reusable component libraries", "Multi-brand theming",
        "User experience design", "UX design", "UI design",
        "WCAG 2.1 AA / 2.2 AA", "Core Web Vitals",
        "Lighthouse", "Progressive Web Apps (PWA)",
        "Internationalization (i18n)", "Localization (l10n)",
        "A/B testing platforms (Adobe Target, LaunchDarkly experiments)",
        "Personalization engines",
    ]},
    {"label": "Micro-Frontend and Platform Architecture", "items": [
        "Module Federation", "single-spa", "Web Components", "Shadow DOM isolation",
        "runtime theming", "contract-tested component libraries",
        "design-token pipelines", "BFF patterns", "edge rendering", "SSR/SSG/ISR",
        "streaming UIs", "multi-tenant UI platforms", "event-driven UIs",
    ]},
    {"label": "Backend, APIs, and Integration", "items": [
        "Node.js", "Express", "Next.js API routes", "NestJS", "Fastify", "tRPC",
        "Go (Gin, Fiber)", "Python (FastAPI, Flask)", "Java (Spring, Spring Boot)",
        "REST", "GraphQL (Apollo Server and Client)", "gRPC", "WebSockets",
        "Server-Sent Events", "OpenAPI / Swagger", "OAuth 2.0", "OIDC", "SAML",
        "JWT", "Okta", "Auth0", "federated SSO",
    ]},
    {"label": "Databases and Data Stores", "items": [
        "PostgreSQL", "MySQL", "SQL Server", "MongoDB", "DynamoDB", "Firestore",
        "Redis", "pgvector", "Pinecone", "Weaviate", "Elasticsearch", "BigQuery",
    ]},
    {"label": "AWS Cloud", "items": [
        "Lambda", "EC2", "ECS", "Fargate", "S3", "CloudFront", "API Gateway",
        "DynamoDB", "RDS", "SQS", "SNS", "EventBridge", "Step Functions",
        "Kinesis", "IAM", "Cognito", "Route 53", "Secrets Manager", "CloudWatch", "X-Ray",
    ]},
    {"label": "GCP Cloud", "items": [
        "Cloud Run", "Cloud Functions", "GKE (Kubernetes)", "Firestore",
        "Cloud Storage", "Pub/Sub", "BigQuery", "Cloud SQL", "Identity Platform",
        "Cloud Build", "Artifact Registry",
    ]},
    {"label": "Edge and Serverless", "items": [
        "Vercel", "Cloudflare Workers", "Cloudflare Pages", "Cloudflare R2",
        "Cloudflare KV", "Netlify", "Deno Deploy", "AWS Lambda@Edge",
    ]},
    {"label": "AI / LLM Engineering", "items": [
        "Anthropic Claude API (Opus, Sonnet, Haiku)",
        "OpenAI API (GPT-4, GPT-4o, o1)", "Vercel AI SDK", "LangChain", "LangGraph",
        "Model Context Protocol (MCP)", "Retrieval-Augmented Generation (RAG)",
        "semantic search", "vector databases", "embeddings", "prompt engineering",
        "evals", "agentic workflows", "tool use", "function calling",
        "AI code-review agents",
    ]},
    {"label": "AI Coding Tools", "items": [
        "Generative AI tools", "Claude Code", "Cursor", "GitHub Copilot",
        "Windsurf", "v0", "AI-assisted code review", "AI-augmented delivery",
    ]},
    {"label": "Data Engineering and Orchestration", "items": [
        "Apache Airflow", "DAG authoring and scheduling",
        "data pipeline orchestration", "ETL / ELT workflows",
        "batch and streaming pipelines", "BigQuery", "Pub/Sub", "Kinesis",
    ]},
    {"label": "Infrastructure and DevOps", "items": [
        "Docker", "Kubernetes", "Helm", "Terraform", "Pulumi", "Ansible",
        "Jenkins", "GitHub Actions", "CircleCI", "GitLab CI", "ArgoCD",
        "Vercel", "trunk-based development", "feature flags (LaunchDarkly, Split)",
        "blue-green deploys", "canary releases", "progressive delivery",
    ]},
    {"label": "Observability, Performance, and Quality", "items": [
        "Datadog", "Sentry", "OpenTelemetry", "Grafana", "Prometheus",
        "New Relic", "Adobe Analytics", "Adobe Launch", "Google Analytics",
        "real-user monitoring (RUM)", "Core Web Vitals", "Lighthouse CI",
        "WebPageTest", "axe accessibility", "SEO (structured data, semantic HTML)",
        "Web performance optimization", "Incident resolution", "Incident response",
        "Postmortems", "Blameless retrospectives",
    ]},
    {"label": "Testing", "items": [
        "Vitest", "Jest", "Jasmine", "Karma", "Mocha", "Testing Library",
        "Playwright", "Cypress", "Puppeteer", "Storybook interaction tests",
        "contract testing (Pact)", "visual regression (Chromatic, Percy)",
        "unit, integration, E2E, and a11y testing",
    ]},
    {"label": "Architecture Patterns", "items": [
        "Micro-frontends", "Module Federation", "event-driven systems", "CQRS",
        "distributed systems", "multi-tenancy", "edge computing",
        "BFF", "hexagonal architecture", "DDD", "clean architecture",
        "functional programming", "reactive programming",
    ]},
    {"label": "Process and Delivery", "items": [
        "Agile", "Scrum", "Kanban", "SAFe", "SDLC", "Jira", "Confluence",
        "Linear", "Notion", "RFCs", "design reviews", "code reviews",
        "cross-geo team coordination", "KPI dashboards",
    ]},
    ...
    {"label": "Domains and Methodologies", "items": [
        # SaaS shape — Midigator (chargeback SaaS), Equifax consumer suite, Strayer
        "SaaS", "B2B SaaS", "Multi-tenant SaaS",
        # Consumer / B2B mix — Fitbit, Bose, AARP, Telstra, ExxonMobil, nowfloats
        "Consumer Web", "B2B", "B2C", "Enterprise Web Applications",
        # Industry verticals he's actually shipped for
        "Fintech", "Consumer Credit and Identity", "Payments and Chargeback",
        "EdTech", "HealthTech", "Telecommunications", "Energy / Utilities",
        ...
        "DevOps", "DevEx / Developer Experience", "Platform Engineering",
        "Site Reliability Engineering (SRE)", "Continuous Delivery",
        "Trunk-based Development", "Progressive Delivery",
        "Microservices Architecture", "Event-Driven Architecture",
        "API-first Design", "Headless / Composable Architecture",
        # Compliance / regulatory experience
        "SOC 2", "GLBA", "CCPA", "GDPR", "WCAG 2.1 AA Accessibility",
    ]},
]
